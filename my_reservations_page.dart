...
class _MyReservationsPageState extends State<MyReservationsPage> {
  ...
  Widget build(BuildContext context) {
    // Si no hay sesión, no tiene sentido (ni permiso) leer las reservas.
    // Mostramos un mensaje amigable en lugar del error de Firestore.
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Aquí podrás seguir el estado de tus solicitudes y pagar las aprobadas.',
                textAlign: TextAlign.center,
